      ...
      <div className="grid lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1">
          <div className="glass-panel bento-card p-6 sticky top-24 rounded-2xl animate-slide-right">
            ...
            <Link href="/checkout">
              <Button className="w-full h-12 rounded-full bg-gradient-to-r from-violet-600 to-indigo-600 hover:from-violet-500 hover:to-indigo-500 text-white font-semibold shadow-xl shadow-violet-500/20 btn-glow transition-all">
